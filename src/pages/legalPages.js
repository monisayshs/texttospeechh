...
const LEGAL_PAGES = {
  about: {
    ...
    content: `
      <div class="legal-hero-card glass-panel" style="padding: 2rem; border-radius: 16px; margin-bottom: 2rem;">
        <h2 style="font-size: 1.8rem; margin-bottom: 1rem;">Our Story & Mission</h2>
        <p style="font-size: 1.08rem; line-height: 1.8; margin-bottom: 1.2rem;">
      ...
      <div class="features-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 1.5rem; margin-bottom: 2.5rem;">
        <div class="feature-card glass-panel">
          <div style="font-size: 2rem; margin-bottom: 0.8rem;">🎯</div>
          <h3 style="font-size: 1.25rem; margin-bottom: 0.5rem;">Our Mission</h3>
          <p style="font-size: 0.95rem; line-height: 1.6;">To empower creators, educators, podcasters, and businesses with human-quality, natural neural speech synthesis at zero cost.</p>
        </div>
        <div class="feature-card glass-panel">
          <div style="font-size: 2rem; margin-bottom: 0.8rem;">🌟</div>
          <h3 style="font-size: 1.25rem; margin-bottom: 0.5rem;">Our Vision</h3>
          <p style="font-size: 0.95rem; line-height: 1.6;">A world where written literature, educational content, and digital media are instantly accessible in audible format across 100+ global languages.</p>
        </div>
        <div class="feature-card glass-panel">
          <div style="font-size: 2rem; margin-bottom: 0.8rem;">⚡</div>
          <h3 style="font-size: 1.25rem; margin-bottom: 0.5rem;">High-Speed Architecture</h3>
          <p style="font-size: 0.95rem; line-height: 1.6;">Serverless infrastructure optimized to generate multi-minute speech audio streams in less than 1.8 seconds.</p>
        </div>
      </div>

      <h2 style="font-size: 1.6rem; margin: 2rem 0 1rem 0;">Why Creators Choose ${BRAND_NAME}</h2>
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.2rem; margin-bottom: 2.5rem;">
        <div class="feature-card glass-panel">
          <h4 style="margin-bottom: 0.4rem; font-size:1.1rem;">100% Free & Unlimited Access</h4>
          <p style="font-size: 0.95rem;">No mandatory credit card requirements, no hidden API charges, and no artificial daily tokens.</p>
        </div>
        <div class="feature-card glass-panel">
          <h4 style="margin-bottom: 0.4rem; font-size:1.1rem;">10,000 Word Long-Script Queue</h4>
          <p style="font-size: 0.95rem;">Paragraph chunking and quote-preservation engines process full YouTube scripts, audiobooks, and documents without mid-sentence truncation.</p>
        </div>
        <div class="feature-card glass-panel">
          <h4 style="margin-bottom: 0.4rem; font-size:1.1rem;">PDF, DOCX & TXT File Extractor</h4>
          <p style="font-size: 0.95rem;">Drag and drop PDF books, Word documents, or text scripts directly into the editor for automatic instant text extraction.</p>
        </div>
        <div class="feature-card glass-panel">
          <h4 style="margin-bottom: 0.4rem; font-size:1.1rem;">Full Commercial Rights Included</h4>
          <p style="font-size: 0.95rem;">All synthesized audio MP3 files generated on ${BRAND_NAME} are 100% permitted for commercial monetization across YouTube, podcasts, ads, and SaaS apps.</p>
        </div>
      </div>

      <h2 style="font-size: 1.6rem; margin: 2rem 0 1rem 0;">Single Unified Contact Point</h2>
      <p style="font-size: 1.05rem; line-height: 1.7; margin-bottom: 1.5rem;">
        ...
        <strong><a href="mailto:${SINGLE_OFFICIAL_EMAIL}" style="color:var(--accent-color);">${SINGLE_OFFICIAL_EMAIL}</a></strong>.
      </p>

      <div class="glass-panel" style="padding: 2rem; border-radius: 14px; text-align: center; margin-top: 2rem;">
  ...
  contact: {
    ...
    content: `
      <p style="font-size: 1.1rem; margin-bottom: 2rem;">
        Have questions, feedback, or need technical help with ${BRAND_NAME}? Email our single unified inbox directly at <strong><a href="mailto:${SINGLE_OFFICIAL_EMAIL}" style="color:var(--accent-color);">${SINGLE_OFFICIAL_EMAIL}</a></strong> or use the floating support chat widget at the bottom right.
      </p>
      ...
      <div class="glass-panel" style="padding: 1.5rem; border-radius: 12px; margin-bottom: 2.5rem;">
        <div style="display: flex; align-items: center; gap: 16px; flex-wrap: wrap;">
          ...
          <div>
            ...
            <p style="font-size: 0.95rem;">All messages, technical questions, and legal inquiries are received exclusively at: <strong style="color:var(--accent-color);">${SINGLE_OFFICIAL_EMAIL}</strong></p>
          </div>
        </div>
      </div>
    `
  ...
  privacy: {
    ...
    content: `
      <p style="font-size: 0.9rem; margin-bottom: 1.5rem;">Effective Date: July 26, 2026</p>
      ...
      <h2 style="font-size: 1.4rem; margin: 1.8rem 0 1rem 0;">1. Text Script & Audio File Storage</h2>
      ...
      <h2 style="font-size: 1.4rem; margin: 1.8rem 0 1rem 0;">2. Log Files & Analytics</h2>
      <p style="font-size: 1rem; line-height: 1.7; margin-bottom: 1.5rem;">
      ...
      <h2 style="font-size: 1.4rem; margin: 1.8rem 0 1rem 0;">3. Contact Information</h2>
      <p style="font-size: 1rem; line-height: 1.7;">
        For privacy-related inquiries or data deletion requests, contact our legal team:<br>
        <strong>Email:</strong> <a href="mailto:${SINGLE_OFFICIAL_EMAIL}" style="color:var(--accent-color);">${SINGLE_OFFICIAL_EMAIL}</a>
      </p>
    `
  },
  ...
  terms: {
    ...
    content: `
      ...
      <h2 style="font-size: 1.4rem; margin: 1.8rem 0 1rem 0;">1. Commercial Usage Rights</h2>
      <p style="font-size: 1rem; line-height: 1.7; margin-bottom: 1.5rem;">
      ...
      <h2 style="font-size: 1.4rem; margin: 1.8rem 0 1rem 0;">2. Acceptable Use Policy</h2>
      <p style="font-size: 1rem; line-height: 1.7; margin-bottom: 1.5rem;">
      ...
      <h2 style="font-size: 1.4rem; margin: 1.8rem 0 1rem 0;">3. Official Support</h2>
      <p style="font-size: 1rem; line-height: 1.7;">
  ...
  disclaimer: {
    ...
    content: `
      ...
      <h2 style="font-size: 1.4rem; margin: 1.8rem 0 1rem 0;">1. Trademark & Brand Notice</h2>
      <p style="font-size: 1rem; line-height: 1.7; margin-bottom: 1.5rem;">
      ...
      <h2 style="font-size: 1.4rem; margin: 1.8rem 0 1rem 0;">2. Contact Information</h2>
      <p style="font-size: 1rem; line-height: 1.7;">
  ...
  cookie: {
    ...
    content: `
      ...
      <h2 style="font-size: 1.4rem; margin: 1.8rem 0 1rem 0;">1. How We Use Cookies</h2>
      <p style="font-size: 1rem; line-height: 1.7; margin-bottom: 1.5rem;">
      ...
      <h2 style="font-size: 1.4rem; margin: 1.8rem 0 1rem 0;">2. Contact Us</h2>
      <p style="font-size: 1rem; line-height: 1.7;">
