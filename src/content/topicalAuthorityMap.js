...
const INTENT_SILOS = {
  transactional: [
    ...
    { title: "Convert Text to MP3", url: `${DOMAIN}/keyword/free-ai-voice-generator`, targetKw: "text to mp3 online" },
  ...
  informational: [
    { title: "The Ultimate Guide to Free AI Voice Generation in 2026", url: `${DOMAIN}/blog/ultimate-ai-voice-generator-guide`, targetKw: "what is ai text to speech" },
