...
const INTENT_SILOS = {
  transactional: [
    ...
    { title: "Text to Speech Free", url: `${DOMAIN}/text-to-speech/free-text-to-speech`, targetKw: "text to speech free" },
    { title: "Convert Text to MP3", url: `${DOMAIN}/text-to-speech`, targetKw: "text to mp3 online" },
    { title: "Long Text to Speech", url: `${DOMAIN}/text-to-speech`, targetKw: "long text to speech" }
  ],
  commercial: [
    { title: "Professional AI Voiceover for YouTube", url: `${DOMAIN}/text-to-speech/blog/text-to-speech-for-youtube`, targetKw: "ai voice for youtube" },
    { title: "AI Voice Generator for Audiobooks", url: `${DOMAIN}/text-to-speech/txt-to-speech`, targetKw: "ai audiobook generator" },
  ...
  informational: [
    { title: "The Ultimate Guide to Free AI Voice Generation in 2026", url: `${DOMAIN}/text-to-speech`, targetKw: "what is ai text to speech" },
